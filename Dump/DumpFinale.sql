...
INSERT INTO `esercizio` VALUES ('AddPower',120,'Addominali','PancaPiana',NULL),('AddStandard',100,'Addominali','PancaPiana',NULL),('CorsaCardio',130,'Corsa','TapisRoulant',NULL),('CycletteStandard',120,'Cardio','Cyclette',NULL),('DorsoStandard',130,'Dorso','LatMachine',NULL),('EllitticaStandard',130,'Cardio','Ellittica',NULL),('Petto1',120,'Petto','Chest Press',NULL),('PettoStandard',130,'Petto','Manubri',NULL),('PressaOk',150,'Gambe','Pressa',NULL),('PressaPower',160,'Gambe','Pressa',NULL),('Squat100',150,'Squat','Manubri',NULL);
...
INSERT INTO `monitoraggio` VALUES (0,'AddPower','2017-07-02',6,3,20,30,40,NULL,1,0),(0,'AddStandard','2017-07-04',2,3,20,40,50,NULL,10,3),(0,'DorsoStandard','2017-06-07',1,3,20,50,40,NULL,3,3),(1,'AddPower','2017-07-02',5,3,20,30,60,NULL,10,2),(1,'EllitticaStandard','2017-07-11',2,1,NULL,35,NULL,3,1,3),(1,'PressaOk','2017-06-07',5,3,20,20,50,NULL,2,3),(2,'AddPower','2017-07-02',8,3,20,21,60,NULL,20,3),(2,'CorsaCardio','2017-07-04',5,1,NULL,20,NULL,1,2,3),(2,'Squat100','2017-06-07',9,3,20,23,50,NULL,1,3),(3,'CycletteStandard','2017-07-02',6,1,NULL,26,NULL,2,15,4),(3,'EllitticaStandard','2017-07-11',5,1,NULL,21,NULL,2,3,4),(3,'Squat100','2017-06-07',8,3,20,28,30,NULL,20,4),(4,'EllitticaStandard','2017-07-04',5,1,NULL,26,NULL,3,5,5),(4,'Petto1','2017-07-11',4,3,10,23,30,NULL,10,5),(4,'Squat100','2017-06-07',2,3,10,21,50,NULL,5,5),(5,'CycletteStandard','2017-07-02',5,1,NULL,50,NULL,2,30,6),(5,'Petto1','2017-07-11',2,3,20,60,20,NULL,2,6),(5,'Squat100','2017-06-07',3,3,20,30,20,NULL,1,6);
...
INSERT INTO `ordine` VALUES (0,9,'Dimagra',0,'2017-01-01','Incompleto',NULL),(1,8,'Integrators',1,'2017-01-02','Evaso',NULL),(2,7,'PowerUp',2,'2017-01-02','Consegnato','2017-02-02'),(3,6,'PowerUp',3,'2017-02-04','Consegnato','2017-03-01'),(4,5,'Dimagra',4,'2017-05-25','Consegnato','2017-05-30'),(5,4,'Integrators',5,'2017-04-03','Consegnato','2017-04-20'),(6,3,'Vitamins',6,'2017-01-01','Evaso',NULL),(7,2,'Vitamins',7,'2017-01-02','Incompleto',NULL),(8,1,'Dimagra',8,'2017-02-03','Consegnato','2017-02-20'),(9,0,'Integrators',9,'2017-07-09','Consegnato','2017-02-21');
...
INSERT INTO `promozioni` VALUES (1,'Offerta prendi 2 paghi 1'),(2,'Offerta Sconto 50%'),(3,'Offerta Sconto 25%');
...
INSERT INTO `riepilogoordine` VALUES (0,9,'Fyron Body','5'),(1,8,'Polase','10'),(2,7,'Fyron Body','15'),(3,6,'Supradyn','20'),(4,5,'Prozis ','5'),(5,4,'Polase','10'),(6,3,'Fyron Body','15'),(7,2,'Prozis ','20'),(8,1,'Sustenium','30'),(9,0,'ScitecNutrition','10');
/*!40000 ALTER TABLE `riepilogoordine` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `rmonitoraggio`
--

DROP TABLE IF EXISTS `rmonitoraggio`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rmonitoraggio` (
  `CodiceScheda` int(11) NOT NULL,
  `CodiceEsercizio` varchar(45) NOT NULL,
  `SerieEffettive` int(11) DEFAULT NULL,
  `RipetizioniEffettive` int(11) DEFAULT NULL,
...
--
-- Dumping data for table `rmonitoraggio`
--

LOCK TABLES `rmonitoraggio` WRITE;
/*!40000 ALTER TABLE `rmonitoraggio` DISABLE KEYS */;
INSERT INTO `rmonitoraggio` VALUES (0,'AddPower',3,20,30,40,NULL,1),(0,'AddStandard',3,20,40,50,NULL,10),(0,'DorsoStandard',3,20,50,40,NULL,3),(1,'AddPower',3,20,30,60,NULL,10),(1,'EllitticaStandard',1,NULL,35,NULL,3,1),(1,'PressaOk',3,20,20,50,NULL,2);
/*!40000 ALTER TABLE `rmonitoraggio` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `transazione` VALUES (0,'0aaa','2017-06-23','Polase','2'),(2,'0bbb','2017-07-10','Fyron Body','3'),(4,'0ccc','2017-06-25','Prozis','3'),(5,'0ddd','2017-02-28','Sustenium','2'),(5,'0eee','2017-05-21','Polase','4');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserisciAccessibile` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciAccessibile`(IN _Mod INT, IN _Centro INT, IN _NumAcc INT)
BEGIN
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciCliente`(IN _codFiscale VARCHAR(50), IN _nome VARCHAR(50), IN _cognome VARCHAR(50),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserisciConsente1` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciConsente1`(IN _Mod INT, IN _piscina INT, IN _NumAcc INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserisciConsente2` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciConsente2`(IN _Mod INT, IN sala INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserisciModalità` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciModalità`(IN _codmod INT, IN _orario VARCHAR(50), IN _spaziallest BOOL, IN _tipo VARCHAR(50),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserisciPagamento` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciPagamento`(IN CodiceContratto VARCHAR(50), IN NumeroRata INT, IN IstitutoFinanziario VARCHAR(50),
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserisciPotenziamento` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciPotenziamento`(IN Codcontratto VARCHAR(50), IN Muscoli VARCHAR(50), IN Livello VARCHAR(50))
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `InserisciStatoFisico` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `InserisciStatoFisico`( IN CodiceScheda INT, IN CodiceFiscale VARCHAR(50), IN DataScheda DATE,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ModificaScheda` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ModificaScheda`(in _cf VARCHAR(45))
begin
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ReportMonitoraggio`(in _codFiscale VARchar(45), in _dataAnalisi date)
begin

declare finito integer default 0;
declare a int default 0;
declare b VARCHAR(45) default ' ';
...
select
	m.CodiceScheda, m.CodiceEsercizio, avg(m.SerieEffettive) as SerieEff, avg(m.RipetizioniEffettive) as RepEff,
    avg(m.TempoEffettivo) as TimeEff, avg(m.PesoEffettivo) as PesoEff, avg(m.IntensitaEffettiva) as IntEff,
...
from
    ...
    monitoraggio m
where
	sc.CodiceCliente = _codFiscale
	and m.Accesso > _dataAnalisi
group by
	m.CodiceScheda, m.CodiceEsercizio;
...
scan : loop
	...
	fetch Monitor into a, b, c, d, e, f, g, h;
	if finito = 1 then
		leave scan;
	end if;
	
    
    insert into RMonitoraggio values (a, b, c, d, e, f, g, h);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ReportScadenza` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ReportScadenza`(in _codC int(11))
begin
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `ReportVendite` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `ReportVendite`( in _codC int(11), in _data date)
begin
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `TempiAttesa` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `TempiAttesa`(IN _centro INT)
BEGIN
...
-- Dump completed on 2017-07-09 17:28:07
